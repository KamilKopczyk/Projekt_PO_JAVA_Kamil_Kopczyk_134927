...
\shorttitlePL{Projekt i implementacja systemu do rezerwacji usług łowiska wędkarskiego z wykorzystaniem bazy danych MySQL i języka JAVA~\LaTeX} % skrócona wersja tytułu jeśli jest bardzo długi
...
\include{chapters/1_Streszczenie}
\include{chapters/2_Opis_zalozen_projektu}
\include{chapters/3_Opis_struktury_projektu}
\include{chapters/4_Harmonogram}
\include{chapters/5_Prezentacja_warstwy_użytkowej_projektu}
\include{chapters/6_Testowanie_okienek_błedów_itp}
